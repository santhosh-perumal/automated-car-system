   ...
   <div class="form container">
       ...
       <div class="col-md-12">
           <form method="post" enctype="multipart/form-data">
               <center>
               <h4 class="" style="color: black;"> USER REGISTER</h4></center>
               ...
               <div class="dob" style="width: 300px;">
...
if psubmit:
    if len(form) != 0:
        ...
        pDateOfBirth = form.getvalue("DateOfBirth")
        ...
        if pphoto.filename:
            ...
            q = """INSERT INTO userreg (Name, Contact, Email, Gender, DateOfBirth, City, Street, Pincode, photo, Aadhar, status)
                        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s)"""
            cur.execute(q,(pName, pContact, pEmail, pGender, pDateOfBirth, pCity, pStreet, pPincode, fn, fn2,status))
            con.commit()
            print("""
                    <script>
