...
q = """select * from sellerreg where Status="New" """
cur.execute(q)
det = cur.fetchall()
print("""
      <section style="">
        <div class="container py-5" style="margin-top:50px;">
            <div class="row">
                <div class="col-md-12">
                    <div class="py-3"><h4>NEW SELLER</h4></div>
                    <table class="table">
                        <thead>
                          <tr>
                            <th scope="col">Id</th>
...
for i in det:
    ...
    print(""" 
        ...
        Approve
                ...
                </tr>""" % (i[0], i[1], i[2], i[3], i[4], i[5], i[6], i[7], fn1, fn2, i[0]))
    q = """SELECT * from sellerreg where id='%s'""" % i[0]
    cur.execute(q)
    x = cur.fetchone()
    if x[1] != None:
        n = x[1]
...
if Submit != None:
    q = """update sellerreg set Username="%s", Password="%s" ,Status="Approved" where id='%s' """ % (
