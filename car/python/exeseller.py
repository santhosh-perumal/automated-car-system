...
q = """SELECT * FROM sellerreg where Status = "Approved" """
cur.execute(q)
rec = cur.fetchall()
print("""<section>
     <div class="container">
         <center>Existing Seller</center>
         <div class="row">""")
for i in rec:
    fn = "../images/" + i[8]
    print("""
         <div class="col-md-3 py-5 g-col-3" >
             <div class="card" style="width:16rem;margin:10px;">
                 <img src="%s" class="card-img-top" alt="..." height="150px" width="100px">
                 <div class="card-body">
